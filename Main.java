...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            BufferedImage originalImage = ImageIO.read(new File("C:\\Users\\Lab1_NTI_22\\IdeaProjects\\Atividade\\src\\10.jpg"));
            ...
            ImageIO.write(binarizedImage, "jpg", new File("imagem_processada10.jpg"));
